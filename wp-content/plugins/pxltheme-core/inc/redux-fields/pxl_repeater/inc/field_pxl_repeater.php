...
if ( ! class_exists( 'ReduxFramework_pxl_repeater' ) ) {
	...
	class ReduxFramework_pxl_repeater {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'redux-field-pxl-repeater-js', $this->extension_url . 'inc/field_pxl_repeater.js', array('jquery', 'jquery-ui-core','jquery-ui-accordion', 'jquery-ui-sortable', 'wp-color-picker'), time(), true );
			...
			wp_enqueue_style( 'redux-field-pxl-repeater-css', $this->extension_url . 'inc/field_pxl_repeater.css' , array(), time(), 'all' );
