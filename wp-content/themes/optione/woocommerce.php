...
if(is_singular('product')){
    $pxl_sidebar = optione()->get_sidebar_args(['type' => 'product', 'content_col'=> '9']); // type: blog, post, page, shop, product
}else{
    $pxl_sidebar = optione()->get_sidebar_args(['type' => 'shop', 'content_col'=> '9']); // type: blog, post, page, shop, product
}
?>
    <div class="container">
