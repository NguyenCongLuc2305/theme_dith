 ...
 */
get_header();
$pxl_sidebar_pos = optione()->get_theme_opt( 'blog_sidebar_pos', 'right' );
$pxl_sidebar = optione()->get_sidebar_args(['type' => 'blog', 'content_col'=> '8']); // type: blog, post, page, shop, product
?>
<div class="container">
