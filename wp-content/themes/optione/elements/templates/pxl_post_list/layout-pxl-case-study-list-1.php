...
$layout               = $widget->get_setting('layout_'.$post_type, 'pxl-case-study-list-1');
...
$load_more = array(
    ...
    'show_tag'            => $widget->get_setting('show_tag'),
...
$widget->add_render_attribute( 'wrapper', [
    'id'               => $html_id,
    'class'            => trim('pxl-grid pxl-case-study-list layout-'.$layout),
