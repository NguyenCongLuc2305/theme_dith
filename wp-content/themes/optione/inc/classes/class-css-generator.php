...
class Optione_CSS_Generator {
	...
	function __construct() {
		$this->opt_name = optione()->get_option_name();  
	...
	protected function get_options_output() {
        ...
        $links                           = optione_configs('link');
        $body                            = optione_configs('body');
        $header                          = optione_configs('header');
        $heading                         = optione_configs('heading');
        $heading_font_size               = optione_configs('heading_font_size');
        $menu                            = optione_configs('menu');
        $submenu                        = optione_configs('dropdown');
        $mobile_menu                     = optione_configs('mobile_menu');
        $mobile_submenu                  = optione_configs('mobile_submenu');
        $border                          = optione_configs('border');
        $divider                         = optione_configs('divider');
        $logo                            = optione_configs('logo');
        $button                          = optione_configs('button');
