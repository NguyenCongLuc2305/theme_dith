<?php  
function optione_get_current_page_url() {
...
function optione_woocommerce_query($type='recent_product',$post_per_page=-1,$product_ids='',$categories='',$param_args=[]){
    global $wp_query;
    ...
    if(!empty($product_ids)){
        ...
        $args = optione_product_filter_type_args($type,$args);
    ...
    $pagination = get_the_posts_pagination(array(
        'screen_reader_text' => '',
        'mid_size' => 2,
        'prev_text' => esc_html__('Back', 'optione'),
        'next_text' => esc_html__('Next', 'optione'),
    ));
    global $paged;
    $paged = $pxl_paged; 
...
function optione_product_filter_type_args($type,$args){
    switch ($type) {
        case 'best_selling':
