...
$logo = optione()->get_theme_opt( 'logo_m', ['url' => get_template_directory_uri().'/assets/images/logo.png', 'id' => '' ] );
$p_menu = optione()->get_page_opt('p_menu');
$header_css_cls = optione()->header->get_header_css_class(['class' => '']);
?>
