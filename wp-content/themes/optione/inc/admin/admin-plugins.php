...
class Optione_Admin_Plugins extends Optione_Admin_Page {

	public function __construct() {

		$this->id = 'pxlart-plugins';
		$this->page_title = esc_html__( 'Install Plugins', 'optione' );
		$this->menu_title = esc_html__( 'Install Plugins', 'optione' );
		$this->parent = 'pxlart';
	...
	public function tgmpa_plugin_action( $plugin, $status ) {
		...
		switch( $status ) {
			case 'not-installed':
				$btn_class = 'white';
				$btn_text = esc_html_x( 'Install', 'Plugin installation page.', 'optione' );
			...
			case 'installed':
				$btn_class = 'success';
				$btn_text = esc_html_x( 'Activate', 'Plugin installation page.', 'optione' );
			...
			case 'active':
				$btn_class = 'danger';
				$btn_text = esc_html_x( 'Deactivate', 'Plugin installation page.', 'optione' );
		...
		$btn_text_active = esc_html_x( 'Deactivate', 'Plugin installation page.', 'optione' );
