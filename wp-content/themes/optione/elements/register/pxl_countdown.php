...
//Register Counter Widget
 pxl_add_custom_widget(
    array(
        'name'       => 'pxl_countdown',
        'title'      => esc_html__('PXL Countdown', 'optione'),
        ...
        'params' => array(
            'sections' => array(
                ...
                array(
                    ...
                    'label' => esc_html__('Time to', 'optione' ),
                    'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
                    'controls' => array(
                        array(
                            'name' => 'time_to',
                            'label' => esc_html__('Enter the time', 'optione' ),
                ...
                array(
                    ...
                    'label' => esc_html__('Countdown Number', 'optione' ),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                            'name' => 'number_typography',
                            'label' => esc_html__('Number Typography', 'optione' ),
                        ...
                        array(
                            'name' => 'number_color',
                            'label' => esc_html__('Number Color', 'optione' ),
                ...
                array(
                    ...
                    'label' => esc_html__('Countdown Text', 'optione' ),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
