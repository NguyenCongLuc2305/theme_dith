( function( $ ) {
    ...
    var widget_post_masonry_handler = function( $scope, $ ) {
        $('.pxl-post-grid .pxl-grid-masonry').imagesLoaded(function(){
            $.sep_grid_refresh();
        });
    };
    ...
    $(document).on('click', '.btn-grid-loadmore', function(){
        ...
        $.ajax({
            ...
            data: {
                action: 'optione_load_more_post_grid',
                settings: loadmore,
                security: main_data.wpnonce,
            }
        })
        .done(function (res) {   
            if(res.status == true) {
    ...
    $(document).on('click', '.pxl-grid-pagination.pagin-post .ajax a.page-numbers', function(){
        ...
        $.ajax({
            ...
            data: {
                action: 'optione_get_pagination_html',
    ...
    $(document).on('click', '.btn-product-grid-loadmore', function(){
        ...
        $.ajax({
            ...
            data: {
                action: 'optione_load_more_product_grid',
                settings: loadmore
            }
        })
        .done(function (res) {   
