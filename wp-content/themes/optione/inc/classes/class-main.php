...
if (!class_exists('Optione_Main')) {
    class Optione_Main extends Optione_Base
    {
        ...
        public static function getInstance()
        {
            ...
            if (null === self::$instance) {
                self::$instance = new Optione_Main();
            }
        ...
        public function get_sidebar_args($args = []){
            ...
            $sidebars = ['content_class' => 'col-lg-8 col-xl-8', 'sidebar_class' => 'col-lg-4 col-xl-4', 'wrap_class' => 'pxl-content-wrap'];
        ...
        public function get_sidebar(){
            if ( class_exists( 'WooCommerce' ) && (is_product_category() || is_shop() || is_product() || is_product_tag()) ) {
...
function optione() {
    return Optione_Main::getInstance();
}
// Install
optione(); 
