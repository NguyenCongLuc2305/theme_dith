...
<div class="pxl-fancy-box layout-2">
    <div class="box-inner">
        <div class="box-overlay" style="background-image: url(<?php echo esc_url($settings['image_background']['url']); ?>);">
        </div>
        <div class="box-content">
            <div class="content-inner">
                ...
                <div class="title-position">
                    ...
                    <?php endif; ?>
                    <?php if(!empty($widget->get_setting('position'))): ?>
                        <div class="box-position"><?php
                        pxl_print_html($widget->get_setting('position'));
                        ?></div>
                    <?php endif; ?>
                </div>
            </div>
