...
class PXL_Author_Info_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            ...
            esc_html__('* Pxl Author Information', 'optione'),
            array('description' => esc_html__('Show Author Information', 'optione'),)
        );
    }
            ...
            <div class="content-inner">
                <div class="author-image">
                    <div class="image-wrap flash-hover">
                        <img src="<?php echo esc_url($author_image_url)?>" alt="<?php echo esc_attr__('Author Image', 'optione');?>">
                    </div>
                    <?php
    ...
    function form($instance)
    {
        ...
        ?>
        <div class="optione-image-wrap">
            <label for="<?php echo esc_url($this->get_field_id('author_image')); ?>"><?php esc_html_e('Author Image', 'optione'); ?></label>
            ...
            if ($author_image != "") {
                ?>
                <a href="#" class="pxl-select-image" style="display: none;"><?php esc_html_e('Select Image', 'optione'); ?></a>
                <a href="#" class="pxl-remove-image"><?php esc_html_e('Remove Image', 'optione'); ?></a>
                <?php
            } else {
                ?>
                <a href="#" class="pxl-select-image"><?php esc_html_e('Select Image', 'optione'); ?></a>
                <a href="#" class="pxl-remove-image" style="display: none;"><?php esc_html_e('Remove Image', 'optione'); ?></a>
                <?php
            }
            ?>
        </div>
        <p>
            <label for="<?php echo esc_url($this->get_field_id('author_position')); ?>"><?php esc_html_e( 'Author Position', 'optione' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_url($this->get_field_id('author_name')); ?>"><?php esc_html_e( 'Author Name', 'optione' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_url($this->get_field_id('description')); ?>"><?php esc_html_e('Description', 'optione'); ?></label>
